...
class AutoAnimatedPage extends StatefulWidget {
  const AutoAnimatedPage({super.key});

  @override
  State<AutoAnimatedPage> createState() => _AutoAnimatedPageState();
}

class _AutoAnimatedPageState extends State<AutoAnimatedPage> {
            ...
            slivers: <Widget>[
              SliverPadding(
                ...
                sliver: LiveSliverList(
                  ...
                  itemCount: 4,
                  itemBuilder: animationItemBuilder((index) => VerticalItem(title: index.toString()), padding: EdgeInsets.symmetric(vertical: 8)),
                ),
              ),
              SliverPadding(
                padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
